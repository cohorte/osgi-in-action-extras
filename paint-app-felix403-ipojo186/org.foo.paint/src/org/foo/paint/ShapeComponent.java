...
public class ShapeComponent extends JComponent {
	 ...
	 * named shape. The component acquires the named shape from the drawing frame at
	 * the time of painting, which helps it account for dynamism.
	 * 
	...
	/**
	 * Paints the contents of the component. The component acquires the named shape
	 * from the drawing frame at the time of painting, which helps it account for
	 * dynamism.
	 * 
	 * @param aGraphics The graphics object to use for painting.
	 **/
	@Override
	protected void paintComponent(Graphics aGraphics) {
		...
		wGraphics2D.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
