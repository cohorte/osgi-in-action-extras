 ...
 */
@Component(name = "org.foo.shape.circle.Circle-factory")
@Instantiate(name = "rg.foo.shape.circle.Circle")
@Provides(specifications = { ISimpleShape.class })
public class Circle implements ISimpleShape {

	public static final String CIRCLE_NAME = "Circle";

	public static final String ICON_PNG = "circle.png";
	...
	@ServiceProperty(name = ISimpleShape.NAME_PROPERTY, value = CIRCLE_NAME)
	...
	public void validate() {
		...
		ResourceBundle wRB = ResourceBundle.getBundle("org.foo.shape.circle.resource.Localize");
